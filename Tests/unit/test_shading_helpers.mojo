...
from gonzales.geometry import RGB, Point3f, Vec3f, Ray_C, PrimId_C, Intersection_C, TriangleMesh_C, Material_C, MatKind, GpuTexture_C, NormalSlopeMap_C, ShadowTask_C, LightSampler_C, Instance_C, PathState_C, AreaLight_C, DistantLight_C, PointLight_C, InfiniteLight_C, Sphere_C, MeasuredBRDF_C, dot, cross
...
def test_build_geom_context_full_sphere_prim_returns_exact_analytic_normal() raises:
    ...
    var ctx = ShadeContext(
        ...
        Pointer[PrimId_C, MutUntrackedOrigin].unsafe_dangling(), meshes,
        Pointer[Curve_C, MutUntrackedOrigin].unsafe_dangling(),
        materials,
        Pointer[Pointer[UInt8, MutUntrackedOrigin], MutUntrackedOrigin].unsafe_dangling(),
        Pointer[GpuTexture_C, MutUntrackedOrigin].unsafe_dangling(), 0,
