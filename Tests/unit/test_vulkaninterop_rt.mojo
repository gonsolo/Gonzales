...
def test_vulkaninterop_rt_trace_matches_known_geometry() raises:
    ...
    comptime maxRays = 16
    var no_templates = Pointer[Int64, MutUntrackedOrigin].unsafe_dangling()
    var no_instances = Pointer[Float32, MutUntrackedOrigin].unsafe_dangling()
    var no_instance_tmpl = Pointer[Int32, MutUntrackedOrigin].unsafe_dangling()
    var no_curve_aabbs = Pointer[Float32, MutUntrackedOrigin].unsafe_dangling()
    var no_curve_i32 = Pointer[Int32, MutUntrackedOrigin].unsafe_dangling()
    var no_curve_data = Pointer[Float32, MutUntrackedOrigin].unsafe_dangling()
