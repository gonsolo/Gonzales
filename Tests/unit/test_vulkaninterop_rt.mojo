...
def test_vulkaninterop_rt_trace_matches_known_geometry() raises:
    ...
    comptime maxRays = 16
    var no_templates = UnsafePointer[Int64, MutUntrackedOrigin].unsafe_dangling()
    var no_instances = UnsafePointer[Float32, MutUntrackedOrigin].unsafe_dangling()
    var no_instance_tmpl = UnsafePointer[Int32, MutUntrackedOrigin].unsafe_dangling()
    var no_curve_aabbs = UnsafePointer[Float32, MutUntrackedOrigin].unsafe_dangling()
    var no_curve_i32 = UnsafePointer[Int32, MutUntrackedOrigin].unsafe_dangling()
    var no_curve_data = UnsafePointer[Float32, MutUntrackedOrigin].unsafe_dangling()
