...
def test_di_target_pdf_light_directly_above_matches_hand_computation() raises:
    ...
    var sample_point = Vec3f(Float32(0), Float32(2), Float32(0))
    var light_normal = Vec3f(Float32(0), Float32(-1), Float32(0))
...
def test_di_target_pdf_zero_when_light_faces_away() raises:
    ...
    var alb = RGB(Float32(0.8))
    var sample_point = Vec3f(Float32(0), Float32(2), Float32(0))
    var light_normal = Vec3f(Float32(0), Float32(1), Float32(0))  # facing up, away from hit_point
    var le = RGB(Float32(10.0))
    var p_hat = di_target_pdf(hit_point, normal, alb, sample_point, light_normal, le)
    assert_true(_close(p_hat, Float32(0.0)))
...
def test_di_target_pdf_zero_at_degenerate_distance() raises:
    ...
    var normal = Vec3f(Float32(0), Float32(1), Float32(0))
    var alb = RGB(Float32(0.8))
    var sample_point = Vec3f(Float32(1), Float32(1), Float32(1))
    var light_normal = Vec3f(Float32(0), Float32(-1), Float32(0))
    var le = RGB(Float32(10.0))
    var p_hat = di_target_pdf(hit_point, normal, alb, sample_point, light_normal, le)
    assert_true(_close(p_hat, Float32(0.0)))
...
def test_di_target_pdf_closer_light_gives_higher_value() raises:
    ...
    var light_normal = Vec3f(Float32(0), Float32(-1), Float32(0))
    var le = RGB(Float32(10.0))
    var far = di_target_pdf(hit_point, normal, alb, Vec3f(Float32(0), Float32(4), Float32(0)), light_normal, le)
    var near = di_target_pdf(hit_point, normal, alb, Vec3f(Float32(0), Float32(2), Float32(0)), light_normal, le)
