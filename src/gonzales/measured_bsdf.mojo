...
@always_inline
def _mbsdf_u32(buf: Pointer[UInt8, MutUntrackedOrigin], pos: Int) -> Int:
    return Int((buf.unsafe_offset(pos)).unsafe_bitcast[UInt32]()[unsafe_offset=0])

@always_inline
def _mbsdf_u64(buf: Pointer[UInt8, MutUntrackedOrigin], pos: Int) -> Int:
    return Int((buf.unsafe_offset(pos)).unsafe_bitcast[UInt64]()[unsafe_offset=0])

@always_inline
def _mbsdf_f32(buf: Pointer[UInt8, MutUntrackedOrigin], pos: Int) -> Float32:
...
def _mbsdf_scan_fields(file_buf: Pointer[UInt8, MutUntrackedOrigin], file_size: Int) -> _MbsdfFields:
...
def _pl2d_build_cdf(
    raw: Pointer[Float32, MutUntrackedOrigin], xs: Int, ys: Int, slices: Int
