...
# rejects.
comptime VulkanRtSceneHandle = Pointer[UInt8, MutUntrackedOrigin]
...
def vulkanrt_trace_ray(
    ...
    out_t: Pointer[Float32, MutUntrackedOrigin],
    out_mesh: Pointer[Int32, MutUntrackedOrigin],
    out_triangle: Pointer[Int32, MutUntrackedOrigin],
) -> Int32:
...
def vulkanrt_trace_rays(
    ...
    out_t: Pointer[Float32, MutUntrackedOrigin],
    out_u: Pointer[Float32, MutUntrackedOrigin],
    out_v: Pointer[Float32, MutUntrackedOrigin],
    out_mesh: Pointer[Int32, MutUntrackedOrigin],
    out_triangle: Pointer[Int32, MutUntrackedOrigin],
    out_hit: Pointer[UInt8, MutUntrackedOrigin],
) -> Int32:
    return external_call["vulkanrt_trace_rays", Int32,
        VulkanRtSceneHandle, Int32, Pointer[Float32, MutUntrackedOrigin],
        Pointer[Float32, MutUntrackedOrigin], Pointer[Float32, MutUntrackedOrigin],
        Pointer[Float32, MutUntrackedOrigin], Pointer[Int32, MutUntrackedOrigin],
