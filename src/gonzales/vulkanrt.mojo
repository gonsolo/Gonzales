...
# rejects.
comptime VulkanRtSceneHandle = UnsafePointer[UInt8, MutUntrackedOrigin]
...
def vulkanrt_trace_ray(
    ...
    out_t: UnsafePointer[Float32, MutUntrackedOrigin],
    out_mesh: UnsafePointer[Int32, MutUntrackedOrigin],
    out_triangle: UnsafePointer[Int32, MutUntrackedOrigin],
) -> Int32:
    return external_call["vulkanrt_trace_ray", Int32,
        VulkanRtSceneHandle,
        Float32, Float32, Float32, Float32, Float32, Float32, Float32, Float32,
        UnsafePointer[Float32, MutUntrackedOrigin], UnsafePointer[Int32, MutUntrackedOrigin],
...
def vulkanrt_trace_rays(
    ...
    out_t: UnsafePointer[Float32, MutUntrackedOrigin],
    out_u: UnsafePointer[Float32, MutUntrackedOrigin],
    out_v: UnsafePointer[Float32, MutUntrackedOrigin],
    out_mesh: UnsafePointer[Int32, MutUntrackedOrigin],
    out_triangle: UnsafePointer[Int32, MutUntrackedOrigin],
    out_hit: UnsafePointer[UInt8, MutUntrackedOrigin],
) -> Int32:
    return external_call["vulkanrt_trace_rays", Int32,
        VulkanRtSceneHandle, Int32, UnsafePointer[Float32, MutUntrackedOrigin],
        UnsafePointer[Float32, MutUntrackedOrigin], UnsafePointer[Float32, MutUntrackedOrigin],
        UnsafePointer[Float32, MutUntrackedOrigin], UnsafePointer[Int32, MutUntrackedOrigin],
        UnsafePointer[Int32, MutUntrackedOrigin], UnsafePointer[UInt8, MutUntrackedOrigin]](
