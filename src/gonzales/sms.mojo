...
def _sms_reproject_onto_sphere_anchored(
    ...
    bvh2Nodes: UnsafePointer[BVH2Node, MutUntrackedOrigin] = UnsafePointer[BVH2Node, MutUntrackedOrigin].unsafe_dangling(),
    primIds: UnsafePointer[PrimId_C, MutUntrackedOrigin] = UnsafePointer[PrimId_C, MutUntrackedOrigin].unsafe_dangling(),
    meshes: UnsafePointer[TriangleMesh_C, MutUntrackedOrigin] = UnsafePointer[TriangleMesh_C, MutUntrackedOrigin].unsafe_dangling(),
