...
from .geometry import RGB, Point3f, Vec3f, Material_C, MatKind, Sphere_C, dot, TriangleMesh_C, PrimId_C, Medium_C, MediumInterface_C, Grid_C, NvdbGrid_C, PI, Instance_C, MeasuredBRDF_C, GpuTexture_C, NormalSlopeMap_C, normal_slope_map_none, _is_real_ptr
...
def mojo_parsed_scene_descriptor(
    ...
    sd[unsafe_offset=0].vcmKeepCounts    = Pointer[Int32, MutUntrackedOrigin].unsafe_dangling()
